...
class _PaytmPaymentPageState extends State<PaytmPaymentPage> {
  ...
  void generateTxnToken(int mode, mid, mKey, uid) async {
    ...
    try {
      ...
      var paytmResponse = Paytm.payWithPaytm(mId: mid,
          orderId:orderId, txnToken:txnToken,txnAmount:
          widget.amount.toString(),callBackUrl:  callBackUrl,staging: testing,appInvokeEnabled: false);
